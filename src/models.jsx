...
const IMAGE_MODELS = [
  ...
  },
  {
    ...
    promptStyle: 'NL, sequential weight, quoted text, edit-aware',
    tips: 'GPT Image 2 (OpenAI, 2026) processes language sequentially — first words carry the highest visual weight, so front-load the subject. Quote exact strings for any in-image text ("Open", "SALE 50%"). Photographic constraints land: "shallow depth of field", "background heavily blurred to soft bokeh", "f/1.4 85mm portrait". For edits use two-column logic — state what CHANGES and what STAYS (face, identity, pose, lighting, framing, background, geometry) and add explicit negatives like "no extra objects, no logo drift, no watermark". Real-world materials (frosted glass, marble, water caustics) out-render stacked style adjectives. Describe the photograph, not the fantasy.',
    briefForLLM: 'Front-load the subject — first words carry the highest visual weight. Quote exact in-image text in double quotes. For edits, list BOTH what changes AND what must stay (face, pose, lighting, framing). Real-world materials and camera specs beat stacked style adjectives.',
    targetWords: [35, 70],
    paramSuffix: () => '',
  },
  {
    ...
    badge: 'NB',
    color: 'oklch(0.82 0.15 95)',
    promptStyle: 'natural language, no magic keywords, up to 14 refs',
    tips: 'Nano Banana Pro (Google Gemini 3 Pro Image, Nov 2025) — pure natural language; magic keywords like "4k", "trending on artstation", "masterpiece" actively hurt. Describe subject, composition, action, location, and style in clear sentences. Gemini 3 reasoning gives strong factual/physical plausibility — great for diagrams, infographics, and scenes with coherent logic. Multilingual in-image text rendering is state-of-the-art; for best text results, first converse to design the wording, then ask for the image. Accepts up to 14 reference images in a composition for multi-subject blends.',
    briefForLLM: 'Natural language, no magic keywords (skip "4k / masterpiece / trending on artstation" — they hurt). Clearly describe subject, composition, action, location, style. Be descriptive, not repetitive.',
    targetWords: [25, 55],
    paramSuffix: () => '',
  },
  {
